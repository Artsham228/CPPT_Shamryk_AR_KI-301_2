...
public class Conditioner implements AutoCloseable {
     ...
     * @param logFilePath Шлях до файлу для запису логів.
     * @throws IOException Якщо виникає помилка при відкритті файлу логів.
     */
    ...
    /**
     * @param initialTemp  Початкова цільова температура.
     * @param initialSpeed Початкова швидкість вентилятора.
     * @param initialMode  Початковий режим роботи.
     * @param logFilePath  Шлях до файлу для запису логів.
     * @throws IOException Якщо помилка при відкритті файлу логів.
     */
    ...
    /** * Змінює режим роботи кондиціонера.
